//
//  LeiShopCartViewController.m
//  FyhNewProj
//
//  Created by yh f on 2017/8/8.
...
@interface LeiShopCartViewController ()<UITableViewDelegate,UITableViewDataSource,ShopCartCellDelegate,ShopCartTopCellDelegate>
...
@implementation LeiShopCartViewController{
...
-(UIView *)settleView{
    if (!_settleView) {
        _settleView = [BaseViewFactory viewWithFrame:CGRectMake(0, ScreenHeight-NaviHeight64-40-iPhoneX_DOWNHEIGHT, ScreenWidth, 40) color:UIColorFromRGB(WhiteColorValue)];
...
- (void)nothingShopCart{
    ...
    if (_dataArr.count<=0) {
        ...
        _AllTabView.frame =CGRectMake(0, 0, ScreenWidth,ScreenHeight-64-40);
