...
@interface PhotoChoseView ()<TZImagePickerControllerDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UIAlertViewDelegate,UINavigationControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
...
- (void)setUp{
    ...
    UILabel *showLab = [BaseViewFactory labelWithFrame:CGRectMake(16, 0, ScreenWidth - 32, 39) textColor:UIColorFromRGB(0x434a54) font:APPFONT(15) textAligment:NSTextAlignmentLeft andtext:@"商品主图（最多上传五张）"];
...
- (void)configCollectionView {
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 39, ScreenWidth, 80) collectionViewLayout:layout];
...
- (void)takePhoto {
        ...
        if ([UIImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypeCamera]) {
            ...
            [[self getCurrentVC] presentViewController:self.imagePickerVc animated:YES completion:nil];
        } else {
