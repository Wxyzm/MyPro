...
- (void)setOutPutArrData{
    ...
    if ([self.delegate respondsToSelector:@selector(DidSelectedFNewAccessProUnitViewOutPutBtn:andstatusTitleArr:andcolorTitleArr:andType:)]) {
        [self.delegate DidSelectedFNewAccessProUnitViewOutPutBtn:_kindTitleArr andstatusTitleArr:_statusTitleArr andcolorTitleArr:colorArr andType:1];
    }
